...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    ...
    $data_to_update = array_diff($data_to_update, $customer);
...
<div id="page-wrapper">
    ...
    <form class="well" action="" method="post" enctype="multipart/form-data" id="customer_form" onsubmit="return validPhoneNumber($('#phone').val(), $('#phone2').val())">
